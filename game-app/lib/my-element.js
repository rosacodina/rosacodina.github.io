  ...
  render() {
    return x`
	  	<header-app></header-app>
			${n(this.showGame,
				() => x`<game-view .playerName=${this.input}></game-view>`,
				() => x`
					<section>
						<div> 
							...
							${this.invalidUSer
								? x `<p>Your user name ${this.input} is not valid, please try again</p>`
								: x ``} 
						</div>
					</section>
				`
